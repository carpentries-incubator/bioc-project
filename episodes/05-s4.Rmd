...
The two slots are restricted to store objects of type `SlotType1` and `SlotType2`, respectively.
The class also defines validity rules that check the integrity of data stored in objects each time they are updated.
