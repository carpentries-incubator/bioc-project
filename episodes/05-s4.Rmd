...
As a result, the memory footprint of sequences that contain frequent runs of identical nucleotides can be dramatically reduced without loss of information.
