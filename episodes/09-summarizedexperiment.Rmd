...
ecosystem to become familiar with for effective and robusts analyses.
...
## Accessing information in SummarizedExperiment objects
...
Notably, the `$` operator can be used to access a single column of sample
metadata.
