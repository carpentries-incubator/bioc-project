...
loaded via a namespace (and not attached):
 [1] BiocManager_1.30.23 compiler_4.4.1      fastmap_1.2.0      
 [4] cli_3.6.3           htmltools_0.5.8.1   tools_4.4.1        
 [7] yaml_2.3.10         rmarkdown_2.27      knitr_1.48         
[10] digest_0.6.36       xfun_0.46           rlang_1.1.4        
...
create a valid installation with
  ...
  BiocManager::install("withr", update = TRUE, ask = FALSE, force = TRUE)
