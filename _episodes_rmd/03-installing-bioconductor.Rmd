...
>
> As described above, developers can set `MINOR` to `99` - skipping all values in-between - if they wish to trigger a increment of `MAJOR` for their package in the next release of Bioconductor.
>
> ### Patch version
>
