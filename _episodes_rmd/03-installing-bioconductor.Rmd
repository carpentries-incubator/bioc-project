...
To access the newly released version of those packages, users must install the new version of R first.
...
> However, this is not an absolute requirement as some packages can already have a relatively long history before their submission to Bioconductor.
...
> It should only be incremented by package devleopers to mark breaking changes to the package infrastructure that require the full attention of users who may need to update their workflow.
>
> ### Minor version
>
