...
Over the years, software packages contributed to the Bioconductor project have reflected the evolution and emergence of high-throughput technologies, from microarrays to single-cell genomics, through many variations of sequencing experiments.

Crucially, the project has not only released software packages implementing novel methodologies, but also produced a diverse range of packages types granting access to databases of molecular annotations and experimental datasets.
