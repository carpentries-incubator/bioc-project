...
[Software packages][bioc-software-package] themselves can be subdivided into packages that provide infrastructure (i.e., classes) to store and access data,
...
[Annotation data packages][bioc-annotation-package] provide self-contained databases of diverse genomic annotations (e.g., gene identifiers, biological pathways).
...
[Experiment data packages][bioc-experiment-package] provide self-contained datasets that are often used by software package developers to demonstrate the use of their package on well-known standard datasets in their [package vignettes][package-vignette].

Finally, [workflow packages][bioc-workflow-package] exclusively provide collections of vignettes that demonstrate the combined usage of several other packages as a coherent workflow, but do not provide any new source code or functionality themselves.
...
The Bioconductor project uses `biocViews`, a set of terms from a controlled vocabulary, to classify Bioconductor packages and facilitate their discovery by thematic search on the [Bioconductor website][biocviews-site].
...
[bioc-code-of-conduct]: https://www.bioconductor.org/about/code-of-conduct/
[bioc-software-package]: ../reference.html#software-package
[bioc-annotation-package]: ../reference.html#annotationdata-package
[bioc-experiment-package]: ../reference.html#experimentdata-package
[bioc-workflow-package]: ../reference.html#workflow-package
