...
> > 2. For Bioconductor release `3.14`, *[DESeq2](https://bioconductor.org/packages/3.14/DESeq2)* and *[edgeR](https://bioconductor.org/packages/3.14/edgeR)* are listed at ranks 23 and 28 respectively.
> >    In other words, the two packages are among the most frequently downloaded packages in the Bioconductor project, in this instance with a small advantage in favour of *[edgeR](https://bioconductor.org/packages/3.14/edgeR)*.
> {: .solution}
{: .challenge}
