...
Once the *[BiocManager](https://bioconductor.org/packages/3.13/BiocManager)* package is installed, the `BiocManager::version()` function displays the version (i.e., release) of Bioconductor that is currently active in the R session.
