...
defined in the *[BiocIO](https://bioconductor.org/packages/3.15/BiocIO)* package - with methods
implemented in the *[rtracklayer](https://bioconductor.org/packages/3.15/rtracklayer)* package - as a
...
>
> Refer to the documentation of the *[rtracklayer](https://bioconductor.org/packages/3.15/rtracklayer)*
